...
function Header() {
  ...
  if (!login) {
    ...
    return (
      <div className="h-screen  border border-red-500  z-70 w-screen text-4xl">
        Loading...
      </div>
    );
  }
        ...
        <div className="grid grid-cols-12 shadow-lg    items-center py-4 md:px-9 px-2 ">
          <div className="logo flex gap-1 items-center md:col-span-4 col-span-5  ">
            <Link to="/user/home">
              <img
                ...
                src={
                  "https://res.cloudinary.com/dkkqzmr4l/image/upload/v1691444780/product_images/logo_s7wdrl.png"
                }
                alt="logo"
              />
            </Link>
          ...
          <div className="logo col-span-5 gap-5 justify-center fle  ">
            <div className=" flex bg-gray-100 focus-within:outline outline-1 items-center">
              <svg
                class="w-7 h-4 flex-shrink-0  text-gray-800 dark:text-white"
                aria-hidden="true"
          ...
          <div
            className="relative  flex gap-3 md:col-span-3 col-span-2 justify-self-end "
            id="Log"
          >
            <div
              className="relative cursor-pointer borde p-[17px] bg-gray-500 ring-4  flex justify-center items-center rounded-full"
              onClick={handleClick}
            >
              <span className="absolute  text-white font-medium">A</span>
            </div>

            <span
              className={`${
                showLogout ? `visible` : "hidden"
              } bg-white  absolute right-0 p-3 top-12 shadow-md w-[20vw]  `}
            >
